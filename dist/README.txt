...
End Capture: producer stop -> accepted-frame drain -> EOS -> wait for EC_COMPLETE -> AVI finalization -> OpenDML-aware verification -> SHA-256
Finalization progress UI: live drain/mux/verify/hash phases with actual SHA bytes-read percentage
Final result UI: success/error remains visible after the capture graph is re-armed
